...
In this tutorial, the data model shown in the figure below is created using JSON. The data model is used for managing restaurants, shops and event places with associated areas. 
